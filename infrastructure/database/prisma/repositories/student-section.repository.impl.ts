...
@Injectable()
export class PrismaStudentSectionRepository implements StudentSectionRepository {
  ...
  async findById(id: number): Promise<StudentSection> {
    return this.prisma.studentSection.findUnique({
      where: { id },
      include: {
        student: {
          include: {
  ...
  async create(studentSection: Partial<StudentSection>): Promise<StudentSection> {
    return this.prisma.studentSection.create({
      data: studentSection as any,
      include: {
        student: {
          include: {
            person: true,
  ...
  async update(id: number, studentSection: Partial<StudentSection>): Promise<StudentSection> {
    return this.prisma.studentSection.update({
      where: { id },
      data: studentSection,
      include: {
        student: {
  ...
  async delete(id: number): Promise<void> {
    await this.prisma.studentSection.delete({
      where: { id },
    });
  }
