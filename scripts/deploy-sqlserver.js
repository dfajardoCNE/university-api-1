...
console.log('🚀 Iniciando despliegue para SQL Server...');

try {
  // 1. Configurar base de datos SQL Server
  console.log('🔧 Configurando SQL Server...');
  execSync('npm run db:config:sqlserver', { stdio: 'inherit' });
  ...
  console.log('🎉 Despliegue para SQL Server completado exitosamente!');
