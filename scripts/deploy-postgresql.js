...
console.log('🚀 Iniciando despliegue para PostgreSQL...');

try {
  // 1. Configurar base de datos PostgreSQL
  console.log('🔧 Configurando PostgreSQL...');
  execSync('npm run db:config:postgresql', { stdio: 'inherit' });
  ...
  console.log('🎉 Despliegue para PostgreSQL completado exitosamente!');
